...
fn test_equivs() {
    ...
    let equivs_files = find_ion_text(&test_path("good/equivs"))
        .expect("good/equivs directory not found. git submodule update --init ?");
...
fn equivalent(values: Vec<Vec<ion::Value>>) -> bool {
